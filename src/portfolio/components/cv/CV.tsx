...
import { Cog, CircleDot, Linkedin, Twitter, Instagram, Mail, Phone, MapPin } from 'lucide-react'
        ...
        <section className="cv mx-16">
            ...
            <div className="grid grid-cols-12">
                ...
                <div className="expertise col-span-12 lg:col-span-6">
                    ...
                    <div className="">
                        <p><Cog className="inline-block w-4 h-4 mb-2 animate-spin" /> Python</p>
                        <p><Cog className="inline-block w-4 h-4 mb-2 animate-spin" /> C Programming </p>
                        <p><Cog className="inline-block w-4 h-4 mb-2 animate-spin" /> Full Stack Web Development</p>
                        <p><Cog className="inline-block w-4 h-4 mb-2 animate-spin" /> JAVA</p>
                ...
                <div className="education col-span-12 lg:col-span-6">
                    ...
                    <div className="flex mb-5">
                        <div className="etime w-1/3">
                            <CircleDot className="inline-block w-4 h-4 text-blue-800" /><b> 2017 - 2019</b>
                            <p className="ms-1 border-l-4 border-blue-600 h-3/6"></p>
                            <CircleDot className="inline-block w-4 h-4 text-blue-800" /><b> 2020 - Present</b>
                        </div>
                ...
                <div className="work col-span-12 lg:col-span-6">
                    ...
                    <div className="flex">
                        <div className="wtime ms-2 w-1/5">
                            <CircleDot className="inline-block w-4 h-4 text-blue-800" /><b> 2020</b>
                            <p className="ms-1 border-l-4 border-blue-600 h-1/4"></p>
                            <CircleDot className="inline-block w-4 h-4 text-blue-800" /><b> 2019 - Present</b>
                            <p className="ms-1 border-l-4 border-blue-600 h-1/3"></p>
                            <CircleDot className="inline-block w-4 h-4 text-blue-800" /><b> 2024</b>
                        </div>
                        <div className="wdesc w-4/5 mt-2">
                            <dl className="mb-2"><Cog className="inline-block w-4 h-4 animate-spin" /><b> Graphics Designer and IT Instructor</b></dl>
                            <dd className="mb-2">
                            ...
                            <dl className="mb-2"><Cog className="inline-block w-4 h-4 mt-2 animate-spin" /> <b> Part-time Jobs</b></dl>
                            <dd className="mb-2">
                            ...
                            <dl className="mb-2"><Cog className="inline-block w-4 h-4 mt-2 animate-spin" /> <b> Jr. FullStack Web Developer</b></dl>
                            <dd className="mb-2">
                ...
                <div className="Language col-span-12 lg:col-span-6 text-lg mb-2">
                    ...
                    <div className="certificate col-span-12 lg:col-span-6 mb-2">
                        ...
                        <div className="flex me-auto">
                            <div>
                                <dl><Cog className="inline-block w-4 h-4 animate-spin" /> <b> Vue JS</b></dl>
                                <dd>
                                    CODE IT, Nepal
                                </dd>
                                <dl><Cog className="inline-block w-4 h-4 animate-spin" /> <b> React Js</b></dl>
                                <dd>
                                    UDEMY
                                </dd>
                                <dl><Cog className="inline-block w-4 h-4 animate-spin" /> <b> Ethical Hacking</b></dl>
                                <dd>
                                    UDEMY
                                </dd>
                            </div>
                            <div className="ms-auto me-auto">
                                <dl><Cog className="inline-block w-4 h-4 animate-spin" /> <b> Laravel</b></dl>
                                <dd>
                                    Huncha Digital, Itahari
                                </dd>
                                <dl><Cog className="inline-block w-4 h-4 animate-spin" /> <b> Python</b></dl>
                                <dd>
                                    UDEMY
                                </dd>
                            </div>
                ...
                <div className="ms-2 contact col-span-12 lg:col-span-6">
                    ...
                    <div className='flex flex-col'>
                        <a href="https://www.linkedin.com/in/suman-regmi-0b2440244/" target="_blank" rel="noopener noreferrer">
                            <Linkedin className="inline-block w-4 h-4" /><b> suman-regmi-0b2440244</b>
                        </a>
                        <a href="https://www.twitter.com/@regmisuman_2000" target="_blank" rel="noopener noreferrer">
                            <Twitter className="inline-block w-4 h-4" /><b>  @regmisuman_2000</b>
                        </a>
                        <a href="https://www.instagram.com/regmisuman_2000" target="_blank" rel="noopener noreferrer">
                            <Instagram className="inline-block w-4 h-4" /><b> @regmisuman_2000</b>
                        </a>
                        <a href="mailto:helpmeforhelp@gmail.com" target="_blank" rel="noopener noreferrer">
                            <Mail className="inline-block w-4 h-4" /><b>helpmeforhelp@gmail.com</b>
                        </a>
                        <a href="tel:9800000000">
                        <Phone className="inline-block w-4 h-4" /><b> +977 9800000000</b>
                        </a>
                        <a href="https://goo.gl/maps/7LVxyYngnffWmy4Z6" target="_blank" rel="noopener noreferrer">
                            <MapPin className="inline-block w-4 h-4" /><b> Itahari,Nepal</b>
                        </a>
                    </div>
