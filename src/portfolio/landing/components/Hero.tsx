...
const Hero = ({ darkMode, setActiveSection }: heroProps) => {
    return (
        <section id="home" className="min-h-screen flex flex-col justify-center py-4 duration-500">
            <div className="max-w-4xl">
                <h1 className="text-4xl md:text-6xl font-bold mb-4">
                    Hi, I'm <span className={`${darkMode ? 'text-blue-400' : 'text-blue-600'}`}>Suman Regmi</span>
                </h1>
                <h2 className="text-2xl md:text-4xl font-semibold mb-6">
                    <span className={`${darkMode ? 'text-gray-300' : 'text-gray-800'}`}>Full Stack Developer</span>
